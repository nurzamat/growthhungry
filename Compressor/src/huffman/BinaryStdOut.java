...
/**
 *  The <code>huffman.BinaryStdOut</code> class provides static methods for converting
 ...
 *  <p>
 *  The client should not intermix calls to {@code huffman.BinaryStdOut} with calls
...
public final class BinaryStdOut {
    ...
    private static boolean isInitialized;     // has huffman.BinaryStdOut been called for first time?

    // don't instantiate
    private BinaryStdOut() { }

    // initialize huffman.BinaryStdOut
