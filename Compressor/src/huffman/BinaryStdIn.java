...
/**
 *  The <code>huffman.BinaryStdIn</code> class provides static methods for reading
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code huffman.BinaryStdIn} with calls
...
public final class BinaryStdIn {
    ...
    private static boolean isInitialized;   // has huffman.BinaryStdIn been called for first time?
    ...
    public static void close() {
        ...
        try {
            ...
            throw new IllegalStateException("Could not close huffman.BinaryStdIn", ioe);
        }
    }
